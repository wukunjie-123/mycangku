	...
	<div class="detail">
		...
		<div class="content" v-if="detail.title">
		  <div class="header clear">
			  <h2><img width="50" :src="$baseUrl + detail.detail.auth_icon" alt=""/></h2>
			  <p>{{detail.detail.auth}}</p></div>
		  <div class="cont">
		    <h3>{{detail.title}}</h3>
...
<style scoped>
	...
	.content{max-width:6.4rem; margin-top:0.6rem; background:#f2f4f5; padding-bottom:0.85rem;}
